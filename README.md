...
---------------------
In the initial Phase of the Data Cleaning and preparations using Ms Excel, the following were performed;
- Data review/inspection
- Removing duplicates
- Handling missing variables
- Creating New Columns (Month and Net Refund)

  ## Exploratory Data Analysis
  EDA was implored to extract insights from the data through insightful questions such as;
  i) What is the return status?
  ii) What are the most common reasons for returns?
